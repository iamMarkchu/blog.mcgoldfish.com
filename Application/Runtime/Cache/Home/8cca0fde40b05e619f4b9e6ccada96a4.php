    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><div class="col-md-4">
                            <div class="panel panel-default home-recommand-block">
                                <div class="panel-heading">
                                    <a href="<?php echo generate_url('article', $article['id']);?>"><img src="<?php echo ((isset($article["image"]) && ($article["image"] !== ""))?($article["image"]):"/Public/400_58bd7e57a9cf6.png"); ?>" alt="" class="img-responsive"></a>
                                </div>
                                <div class="panel-body">
